        ...
        >
          <div className="sm:max-w-[46%]">
            ...
            <h2 className="sm:ml-5 text-xl mt-8 sm:mt-5">
              No cheap page builders or WordPress. We offer 100% custom
              hand-coded websites with superior results starting at 1000kr /
              month.
            </h2>
            <button
        ...
        <div className={`${maxw} mt-32 pb-32`}>
          <div className="flex flex-col items-center mb-16">
            ...
            <div className="flex items-center p-1 space-x-1 bg-gray-100 rounded-full border border-[#074C97]">
              <button
                ...
                className={`px-4 sm:px-8 py-2 cursor-pointer rounded-full text-sm sm:text-base font-semibold duration-300 ${
                  !isMonthly
                    ? "bg-[#074C97] text-white"
                    : "text-[#074C97] hover:opacity-80"
                }`}
              >
                Upfront + Hosting
              </button>
            ...
            <p className="text-gray-500 mt-4 text-sm italic">
              {isMonthly
                ? "Zero upfront cost — includes maintenance"
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-8 items-start">
            {tiers.map((tier) => (
              ...
              >
                ...
                <h3 className="text-2xl font-bold text-[#074C97] mb-2">
                  {tier.name}
                </h3>
                ...
                <ul className="space-y-4 mb-10 grow">
                  {tier.features.map((feature) => (
                    ...
                    >
                      <svg
                        className="w-5 h-5 text-[#074C97] shrink-0"
                        fill="none"
                        stroke="currentColor"
                        viewBox="0 0 24 24"
                      >
